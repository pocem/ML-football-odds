"""
Builds data/processed/all_seasons_14window.csv -- same as all_seasons_with_bookies.csv,
...
INPUT_FILE = "data/processed/all_seasons_with_bookies.csv"
OUTPUT_FILE = "data/processed/all_seasons_14window.csv"
SPAN = 14
