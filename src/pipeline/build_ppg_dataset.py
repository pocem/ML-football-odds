"""
Builds data/processed/all_seasons_14window_ppg.csv -- same as all_seasons_14window.csv,
...
INPUT_FILE = "data/processed/all_seasons_14window.csv"
OUTPUT_FILE = "data/processed/all_seasons_14window_ppg.csv"
